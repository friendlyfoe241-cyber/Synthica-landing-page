...
export default function Home() {
  ...
  // ── Fluid Typography Scale (power = 0.85) ───────────────────────────────
  // The canvas scales every element at (window.innerWidth / 1440).
  // • tf(px)  – text scales at scale^0.85 instead of scale^1.
  //             At 1000 px (scale≈0.69) text is only ~6% larger than canvas;
  //             at 390 px (scale≈0.27) text is ~22% larger – more legible.
  //             Formula inside canvas: designPx / scale^0.15, so rendered = designPx × scale^0.85.
  // • bx(origin) – apply to wrapper BOXES (nav pills, button) so they expand
  //             by the same counter-factor and text stays contained inside them.
  //             Text inside a bx() container should use original Tailwind sizes (no tf).
  const fluidC = 1 / Math.pow(scale || 1, 0.15);           // counter-factor ≈ 1.06 at 1000 px
  const tf = (px: number) => ({ fontSize: `${px * fluidC}px` });
  const bx = (origin = 'top left') => ({ transform: `scale(${fluidC})`, transformOrigin: origin });
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-[264px] absolute left-0 top-[148px] flex flex-col items-center justify-center">
        <div className="flex flex-col items-center" style={bx('center')}>
      ...
      <div className="rounded-[20px] bg-[rgba(188,188,188,0.10)] w-[175px] h-[60px] absolute left-7 top-[47px]" style={bx()}></div>
      <div className="w-[140px] h-[42px] absolute left-[42px] top-14" style={bx()}>
      ...
      <div className="w-[457px] h-[60px] absolute right-7 top-[47px]" style={bx('top right')}>
      ...
      <div
        id="lockable-box"
        className="absolute left-[197px] top-[1579px]"
        style={{ transform: `translateY(${stickyY}px)`, zIndex: 50 }}
      >
        <div className="relative" style={bx('top left')}>
          ...
          <p className="text-[#4B4B4B] font-googleSansFlex text-2xl w-[398px] h-12 absolute left-0 top-[119px]">
      ...
      <img
        ...
        alt="Rectangle 9"
      />
      <div className="w-[424px] h-[72px] absolute left-[729px] top-[1010px]" style={bx('top left')}>
        <p className="text-[#000] font-googleSansFlex font-medium text-[40px] w-[142px] h-[52px] absolute left-[140px] top-0">
          16000+
        </p>
      ...
      <div className="w-[98px] h-[19px] absolute left-[811px] top-[1255px]" style={bx('left center')}>
        ...
        <p className="text-[#244A73] font-googleSansFlex font-medium text-sm w-[81px] h-[19px] absolute left-[17px] top-0">
          Community
        </p>
      </div>
      <div className="w-[114px] h-[19px] absolute left-[954px] top-[1255px]" style={bx('left center')}>
        <p className="text-[#244A73] font-googleSansFlex font-medium text-sm w-[97px] h-[19px] absolute left-[17px] top-0">
          Opportunities
        </p>
        <div className="w-[13px] h-[13px] absolute -left-0 top-[3px]">
          <div className="w-[13px] h-[13px] absolute left-0 top-0">
      ...
      <div className="w-[111px] h-[19px] absolute left-[903px] top-[1301px]" style={bx('left center')}>
        <p className="text-[#244A73] font-googleSansFlex font-medium text-sm w-[94px] h-[19px] absolute left-[17px] -top-0">
          Competitions
        </p>
        <div className="w-[13px] h-[13px] absolute -left-0 top-[3px]">
          <div className="w-[13px] h-[13px] absolute left-0 top-0">
      ...
      <div className="w-10 h-10 absolute left-[647px] top-[1589px]" style={bx('center')}>
      ...
      <div className="w-10 h-10 absolute left-[647px] top-[2047px]" style={bx('center')}>
        <div className="rounded-[50px] bg-[#244A73] w-10 h-10 absolute -left-0 -top-0"></div>
        <p className="text-[#FFF] font-googleSansFlex text-2xl w-2.5 h-6 absolute left-[13px] top-[5px] text-center">
          2
        </p>
      </div>
      <div className="w-10 h-10 absolute left-[647px] top-[2506px]" style={bx('center')}>
        <div className="rounded-[50px] bg-[#244A73] w-10 h-10 absolute -left-0 -top-0"></div>
        <p className="text-[#FFF] font-googleSansFlex text-2xl w-2.5 h-6 absolute left-[13px] top-[5px] text-center">
          3
        </p>
      </div>
      <div className="w-10 h-10 absolute left-[647px] top-[2965px]" style={bx('center')}>
        <div className="rounded-[50px] bg-[#244A73] w-10 h-10 absolute -left-0 top-0"></div>
      ...
      <div className="w-[566px] h-[410px] absolute left-[717px] top-[1589px]">
        ...
        <div className="rounded-[30px] bg-[#FFF] shadow-[02px2px0rgba(0,0,0,0.25)] w-[482px] h-[72px] absolute left-[43px] top-[307px]" style={bx('left center')}></div>
        <div className="w-[359px] h-[31px] absolute left-[104px] top-[328px]" style={bx('left center')}>
      ...
      <div className="w-[566px] h-[410px] absolute left-[717px] top-[2043px]">
        ...
        <div className="rounded-[30px] bg-[#FFF] shadow-[02px2px0rgba(0,0,0,0.25)] w-[482px] h-[72px] absolute left-[43px] top-[307px]" style={bx('left center')}></div>
        <div className="w-[398px] h-[31px] absolute left-[84px] top-[328px]" style={bx('left center')}>
          <div className="w-6 h-6 absolute -left-0 top-[3px] overflow-hidden">
            <div className="w-6 h-6 absolute left-0 top-0">
              <div className="bg-[#000] w-[3px] h-[3px] absolute left-0 top-[3px]"></div>
              <div className="bg-[#000] w-[3px] h-[3px] absolute left-0 top-1.5"></div>
      ...
      <div className="w-[566px] h-[410px] absolute left-[717px] top-[2499px]">
        ...
        <div className="rounded-[30px] bg-[#FFF] shadow-[02px2px0rgba(0,0,0,0.25)] w-[482px] h-[72px] absolute left-[43px] top-[307px]" style={bx('left center')}></div>
        <div className="w-[565px] h-[31px] absolute left-[93px] top-[328px]" style={bx('left center')}>
          <div className="w-6 h-6 absolute left-0 top-[3px] overflow-hidden">
      ...
      <div className="w-[325px] h-[31px] absolute left-[845px] top-[3285px]" style={bx('left center')}>
      ...
      <div className="w-full h-[714px] absolute left-0 top-[4541px]">
        ...
        <div className="flex py-px px-14 flex-col justify-center items-start border-t border-t-[#000] border-b border-b-[#000] bg-[#FFF] w-full h-[601px] absolute left-0 top-[57px]">
          <div className="flex pr-px flex-col items-start shrink-0 border-r border-r-[#000] border-l border-l-[#000] w-full h-[601px]">
            <div className="flex flex-col justify-center items-start w-full">
              <img
                src="/Backgroundborder.png"
                className="border border-[#000] w-[1329px] h-[602px] overflow-hidden max-w-none"
          ...
          <div className="flex pt-0 pr-[468px] pb-0 pl-[18px] items-center gap-0.5 border-r border-r-[#000] border-l border-l-[#000] w-full h-[55px]">
            ...
            <div className="w-3.5 h-3.5 relative">
              <div className="w-3.5 h-3.5 absolute left-0 top-0">
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0 top-0.5"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0 top-1"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0 top-[5px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0 top-[7px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[9px] top-0.5"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[9px] top-1"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[9px] top-[5px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[9px] top-[7px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[9px] top-[9px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[9px] top-[11px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0.5 top-0.5"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0.5 top-1"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0.5 top-[5px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0.5 top-[7px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0.5 top-[9px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[5px] top-1"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[5px] top-[5px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[5px] top-[7px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[5px] top-[9px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[5px] top-[11px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[5px] top-3"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-0.5 top-0"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[11px] top-0.5"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[11px] top-1"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[11px] top-[5px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[11px] top-[7px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[11px] top-[9px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[11px] top-0"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-1 top-0.5"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-1 top-1"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-1 top-[5px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-1 top-[7px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-1 top-[9px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-1 top-[11px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[7px] top-1"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[7px] top-[5px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[7px] top-[7px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[7px] top-[9px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[7px] top-[11px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-[7px] top-3"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-3 top-0.5"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-3 top-1"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-3 top-[5px]"></div>
                <div className="bg-[#FF0000] w-0.5 h-0.5 absolute left-3 top-[7px]"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="inline-flex items-start gap-10 h-[124px] absolute left-[157px] top-[3580px]">
        ...
        <div className="flex p-7 flex-col items-start gap-2.5 rounded-xl border border-[#E7E7E7] bg-[#FFF] w-[370px] absolute left-[784px] top-0 overflow-hidden">
      ...
      <div className="flex py-[42px] px-0 justify-center items-center bg-[#FFF] w-full h-[716px] absolute left-[30px] top-[3765px] overflow-hidden">
        <div className="shrink-0 w-full h-[632px] relative">
          ...
          <div className="w-[1070px] h-[529px] absolute left-[205px] top-28">
