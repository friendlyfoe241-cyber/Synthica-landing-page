...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <p className="text-[#000] font-googleSansFlex text-[40px] font-medium bg-linear-[90deg,#B0DBFD0%,#0070C84.81%] w-[450px] h-[101px] absolute left-[187px] top-[1579px]">
      ...
      <p className="text-[#4B4B4B] font-googleSansFlex text-2xl w-[398px] h-12 absolute left-[187px] top-[1714px]">
